...
const LandingNavbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-50 flex h-20 w-full items-center justify-between bg-[#19223F] px-6 md:px-16">
      <div className="text-3xl font-bold text-white">Truemail</div>
